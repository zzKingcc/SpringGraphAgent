package com.zxcSpringAI.agent.config;
...
import com.zxcSpringAI.infrastructure.memory.RedisCheckpointSaver;
...
public class AgentOrchestrationConfig {
    ...
    public AgentOrchestrationService agentOrchestrationService(
        ...
        return new AgentOrchestrationService(streamingChatModel, chatMemoryProvider, toolRouter, systemMessage, checkpointSaver, cancellationTracker);
    }
}
