...
import com.zxc.stringer.infrastructure.memory.RedisChatMemoryStore;
...
public class MemoryConfig {
     ...
     * 供 MessagesStateGraph（AgentOrchestrationService）和 RedisCheckpointSaver 共用，
     * 确保 Checkpoint 中的 LangChain4j 对象能正确序列化/反序列化。
     * 注意：ChatMessage / ToolExecutionRequest 未实现 java.io.Serializable，
     * 不能使用 Java 原生序列化，必须经由本序列化器处理。</p>
     */
    @Bean
